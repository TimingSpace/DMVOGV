...
class SepeDataset(Dataset):
    ...
    files:
    """
    def __init__(self, path_to_poses_files, path_to_image_lists, transform_=None,camera_parameter=[640,180,640,640,320,90],norm_flag=0,coor_layer_flag=True,color_flag = True):
        """
        Args:
